...
export default function Product({ product, productSelected }) {
  ...
  return (
    <>
      <div className="min-w-[9.625rem] lg:p-[1.125rem_0.9375rem_1.125rem_1.125rem] min-h-[15rem] lg:w-full lg:h-full max-w-[13.9375rem] max-h-[20.25rem] flex flex-col items-center rounded-[1.25rem] shadow-[3px_3px_9px_0_rgba(0,0,0,0.25)] m-auto lg:mt-[1.625rem]">
        <img
        ...
        <div className="lg:flex lg:justify-between lg:w-full">
          <p className="text-base/[2.5rem]">${product?.price}</p>
